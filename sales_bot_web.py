...
if 'retell_api_key' not in st.session_state:
    st.session_state.retell_api_key = os.getenv("RETELL_API_KEY", "key_42d81383677405d471d9868674af")
if 'openai_api_key' not in st.session_state:
    st.session_state.openai_api_key = os.getenv("OPENAI_API_KEY", "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")
if 'from_number' not in st.session_state:
    st.session_state.from_number = os.getenv("FROM_NUMBER", "+13234059278")
        ...
        if 'phone' not in df.columns:
            ...
            if not valid_phones.all():
                ...
                for idx in invalid_indices:
                    ...
                    fixed = self.ai_reformat_phone(original_phone)
